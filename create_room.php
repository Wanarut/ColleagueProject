  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <input type="image" src="img\UI\create.png" alt="submit" width="230" height="70">
      </div>
      <div class="col-sm-4"></div>
    </div>
    </form>
    <div class="row">
      <div class="col-sm-4"></div>
      <div class="col-sm-4">
         <input type="image" src="img\UI\back.png" onclick="window.location.href='client.php'" width="200" height="80">
